    ...
    <div>
      <div className="awesome" >
          ...
          <section className="mb-32 text-gray-800">
            <div className="relative overflow-hidden bg-no-repeat bg-cover" style={{ backgroundPosition: '50%', backgroundImage: 'url("https://mdbootstrap.com/img/new/textures/full/171.jpg")', height: '300px' }}>
            </div>
              ...
              <div className="block rounded-lg shadow-lg py-10 md:py-12 px-4 md:px-6" style={{ marginTop: '-100px', background: 'hsla(0, 0%, 100%, 0.8)', backdropFilter: 'blur(30px)' }}>
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 mb-12">
                  ...
                  <div className="mb-12 lg:mb-0 text-center mx-auto">
                    ...
                    <h6 className="font-medium">Amman, 35</h6>
                  </div>
