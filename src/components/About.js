        ...
        <div className="flex bg-white h-screen">
          <div className="flex items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2">
            <div>
              ...
              <h1 className="py-5 text-5xl font-semibold text-gray-800 md:text-6xl">Font<span className="ml-2 text-blue-600">Generator</span></h1>
              <p className="mt-2 text-sm text-gray-500 md:text-lg"><a href="https://fontgenerator.org/">Font generator</a> is the best free online website to generate cool and stylish <strong>fancy fonts</strong> without any third party app. The website is under construction meanwhile you can follow on below social network.</p>
              <div className="flex space-x-3 justify-center lg:justify-start mt-6">
                ...
                <a href="https://twitter.com/FontGen" className="bg-blue-300 px-4 py-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
                ...
                <a href="#" className="bg-red-500 px-4 py-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
                ...
                <a href="#" className="bg-pink-600 px-4 py-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
          ...
          <div className="hidden lg:block lg:w-1/2">
            <div className="h-full object-cover" style={{backgroundImage: 'url(https://images.unsplash.com/photo-1501854140801-50d01698950b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1400&q=80)'}}>
