            ...
            <div className="flex flex-col flex-1 justify-center mb-8">
              ...
              <div className="w-full mt-4">
                ...
                <div className="flex flex-col mt-4">
                    <input id="fname" type="text" className="flex-grow h-8 px-2 border rounded border-grey-400" name="fname"  placeholder="First Name" />
                  </div>
                  <div className="flex flex-col mt-4">
                    <input id="lname" type="text" className="flex-grow h-8 px-2 border rounded border-grey-400" name="lname"  placeholder="Last Name" />
                  </div>
                  <div className="flex flex-col mt-4">
